    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        ...
        <div className="relative mb-8 animate-scale-in">
          <div className="absolute inset-0 w-32 h-32 rounded-full bg-gradient-to-r from-primary to-accent blur-lg opacity-50 mx-auto animate-pulse" aria-hidden="true" />
          <div 
          ...
          >
            <span className="text-6xl text-primary font-playfair animate-pulse" aria-hidden="true">KM</span>
          </div>
        </div>
        ...
        <div className="h-8 mb-6">
          <p 
            className="text-muted-foreground text-xl md:text-2xl font-medium animate-fade-in" 
        ...
        <p 
          className="max-w-2xl mx-auto text-muted-foreground/90 mb-8 px-4 animate-fade-in text-lg leading-relaxed" 
        ...
        >
          <a
            href="#projects"
            className="group bg-gradient-to-r from-primary to-primary/90 text-primary-foreground font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
        ...
        <div className="animate-bounce">
          <a 
            href="#about"
            className="inline-block text-muted-foreground hover:text-primary transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 rounded"
